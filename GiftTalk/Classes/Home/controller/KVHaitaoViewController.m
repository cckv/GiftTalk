...
@interface KVHaitaoViewController ()
...
- (void)getData:(int)offset
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://api.liwushuo.com/v2/channels/129/items?ad=1&gender=1&generation=0&limit=20&offset=%d",offset];
